...
flowchart TD
    ...
    subgraph CICD["CI / CD"]
        GHA["GitHub Actions\nSchema - Dashboard - Alert Validation"]
    end
    ...
    GLUE -->|"logs and metrics"| CW_SPOKE
    SLS -->|"logs and metrics"| CW_SPOKE
    ...
    SCHEMA_VAL -->|"quarantined"| CW_SPOKE
